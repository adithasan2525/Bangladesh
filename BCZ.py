#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To D3V1D
#If You Wanna Take Credits For This Code, Please Look Yourself Again...
#Reserved2022
#The Coad Dcoad by D3V1D 
...
\033[1;91m [⚡\033[1;97mAuthor Name: D3V1D         ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mFacebook Na: Farhan Sagor  ⚡\033[1;91m]
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mHuntter\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "D3V1D"
CorrectPassword = "SAGORsexSUNNYLEONE"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Sagor_Vau 
	    time.sleep(2)
            loop = 'false'
        else:
